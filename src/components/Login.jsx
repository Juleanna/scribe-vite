  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-gray-950 flex items-center justify-center p-4 py-8">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl dark:shadow-gray-900/30 p-6 w-full max-w-full sm:max-w-sm">
        <div className="text-center mb-5">
          <div className="inline-flex items-center justify-center w-11 h-11 rounded-lg bg-indigo-100 dark:bg-indigo-900 text-indigo-700 dark:text-indigo-300 font-bold text-xl mb-2">S</div>
          <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">Scribe</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm">{t('auth.subtitle')}</p>
        </div>
        ...
        <div className="mt-4">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-white dark:bg-gray-800 px-3 text-gray-500 dark:text-gray-400">{t('auth.or')}</span></div>
          </div>

          <div className="mt-3 space-y-2">
            <a
              href={`${API_BASE}/auth/google/`}
              className="flex items-center justify-center gap-2 w-full border border-gray-300 dark:border-gray-600 rounded-lg py-2 text-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-gray-700 dark:text-gray-300"
            >
        ...
        <p className="text-center text-xs text-gray-500 dark:text-gray-400 mt-4">
          ...
          <button onClick={() => { setIsRegister(!isRegister); setError(''); }} className="text-indigo-600 dark:text-indigo-400 hover:underline font-medium">
