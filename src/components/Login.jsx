      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm max-w-full sm:max-w-sm">
        ...
        <div className="mt-4">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-white px-3 text-gray-500">{t('auth.or')}</span></div>
          </div>

          <div className="mt-3 space-y-2">
            <a
              href={`${API_BASE}/auth/google/`}
              className="flex items-center justify-center gap-2 w-full border border-gray-300 rounded-lg py-2 text-sm hover:bg-gray-50 transition-colors"
            >
